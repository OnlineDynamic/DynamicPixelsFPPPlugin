...
public:
    ...
    virtual ~FPPDynamicPixelsPlugin() {}

    class SetBrightnessCommand : public Command
    {
    public:
        SetBrightnessCommand(FPPDynamicPixelsPlugin *p) : Command("Brightness"), plugin(p)
        {
        ...
        FPPDynamicPixelsPlugin *plugin;
    };
    class AdjustBrightnessCommand : public Command
    {
    public:
        AdjustBrightnessCommand(FPPDynamicPixelsPlugin *p) : Command("Brightness Adjust"), plugin(p)
        {
    ...
    {
    public:
        FadeBrightnessCommand(FPPDynamicPixelsPlugin *p) : Command("Brightness Fade"), plugin(p)
        {
...
extern "C"
{
    ...
    {
        return new FPPDynamicPixelsPlugin();
    }
}